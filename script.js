...
const MENUS = {
    main: {
        title: (name) => `¡Hola <b>${name}</b>! 👋 . ¿En qué puedo ayudarte hoy?, aca tenes los accesos de 🫱🏻‍🫲🏿 RRHH y 🏛️ Servicios al Ciudadano`,
        options: [
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!userName) {
        addMessage("¡Hola! 👋 Soy el asistente de Recursos Humanos. Para empezar, por favor escribí tu <b>Nombre Completo</b>:", "bot");
    } else {
        showMenu('main');
    }
    // Splash Screen
